...
:::
  ...
  [1]: admin/images/architektur_cb.png {width="80%"}
...
Online-Sitzungen per Zoom (**Zugangsdaten siehe [ILIAS IFM 3.1 CB (PO23, 3. Semester)]**). Sie *können* hierzu den Raum
J101 (siehe Stundenplan) nutzen.

  [ILIAS IFM 3.1 CB (PO23, 3. Semester)]: https://www.hsbi.de/elearning/goto.php?target=crs_1400596&client_id=FH-Bielefeld

# Fahrplan

Hier finden Sie einen abonnierbaren [Google Kalender IFM 3.1 CB (PO23, 3. Semester)] mit allen Terminen der
Veranstaltung zum Einbinden in Ihre Kalender-App.

Abgabe der Übungsblätter jeweils **Montag bis 09:00 Uhr** im [ILIAS]. Vorstellung der Lösung im jeweiligen Praktikum in
der Abgabewoche.

| Monat                | Woche | Vorlesung                                                                                                                      | Lead        | Abgabe Aufgabenblatt    | Vorstellung Praktikum                                     |
|:---------------------|:------|:-------------------------------------------------------------------------------------------------------------------------------|:------------|:------------------------|:----------------------------------------------------------|
| Oktober              | 43    | 23.: [CFG] \|\| [B04] `<br>`{=html} [B04] <br> [B04]                                                                           | Carsten, BC |                         |                                                           |
...
1.  ["**Compilers: Principles, Techniques, and Tools**"]. Aho, A. V. und Lam, M. S. und Sethi, R. und Ullman, J. D. and
    Bansal, S., Pearson India, 2023. ISBN [978-9-3570-5488-1].
    [Online]["**Compilers: Principles, Techniques, and Tools**"] über die [O'Reilly-Lernplattform].
2.  ["**Crafting Interpreters**"]. Nystrom, R., Genever Benning, 2021. ISBN [978-0-9905829-3-9]. [Online].
3.  ["**The Definitive ANTLR 4 Reference**"]. Parr, T., Pragmatic Bookshelf, 2014. ISBN [978-1-9343-5699-9].
    [Online]["**The Definitive ANTLR 4 Reference**"] über die [O'Reilly-Lernplattform].
4.  ["Writing a C Compiler"]. Sandler, N., No Starch Press, 2024. ISBN [978-1-0981-8222-9].
    [Online]["Writing a C Compiler"] über die [O'Reilly-Lernplattform].

  ["**Compilers: Principles, Techniques, and Tools**"]: https://learning.oreilly.com/library/view/compilers-principles-techniques/9789357054881/
  ...
  ["**The Definitive ANTLR 4 Reference**"]: https://learning.oreilly.com/library/view/the-definitive-antlr/9781941222621/
  [978-1-9343-5699-9]: https://fhb-bielefeld.digibib.net/openurl?isbn=978-1-9343-5699-9
  ["Writing a C Compiler"]: https://learning.oreilly.com/library/view/writing-a-c/9781098182229/
...
Über das Projekt ["We CAN virtuOWL"] der Fachhochschule Bielefeld ist im Frühjahr 2021 eine Kooperation mit der
[University of Alberta] (Edmonton/Alberta, Kanada) im Modul "Compilerbau" gestartet.
...
Hier steht vielleicht noch mehr - zentrales Readme mit detaillierter Lizenz und Credits. (Nicht mit generiertem
Lizenz-Footer aus cb.yaml verwechseln.)
