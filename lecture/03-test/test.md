...
The preprocessing step, cf. \[@Dietz2018\]
...
![](../02-parsing/images/bc_xml-parsing-error.png)

</div><p>parsing error</p></div>

<div style="text-align: center;"><div>

![](../../admin/images/modulbeschreibung_ba.png)

</div><p>modulbeschreibung</p></div>

------------------------------------------------------------------------

kleines Bild, mit Titel und Breite:

<div style="text-align: center;"><div style="width:5%; margin: 0 auto;">

![](img/b.png)

</div><p>"B", width="5%"</p></div>
...
</div><p>"wuppie" (wide)</p></div>

------------------------------------------------------------------------

breites Bild, mit Breiteangabe:

<div style="text-align: center;"><div style="width:20%; margin: 0 auto;">

![](img/wuppie.png)

</div><p>"wuppie", width="20%"</p></div>
...
![](https://raw.githubusercontent.com/cagix/pandoc-thesis/refs/heads/master/figs/wuppie.png)

</div><p>"wuppie" via web (raw)</p></div>
...
</div><p>"wuppie" via web (raw) (Quelle: "FooFOOOO" by me on
void.intern.com)</p></div>
...
![](img/test_transparentbackground.png)
